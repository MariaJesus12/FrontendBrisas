      ...
      <html>
        <head>
          ...
          <style>
            ...
            .restaurant { font-size: 16px; font-weight: 900; letter-spacing: 0.1px; }
            .subtitle { font-size: 10px; font-weight: 800; color: #374151; margin-top: 1px; }
            .meta-grid {
              display: grid;
            ...
            .item-name { font-size: 11px; font-weight: 800; color: #111827; word-break: break-word; }
            .item-note { font-size: 9px; font-weight: 700; color: #4b5563; margin-top: 1px; white-space: pre-wrap; word-break: break-word; }
            .item-meta {
              display: grid;
            ...
            .total { font-weight: 900; font-size: 12px; color: #111827; }
          </style>
        </head>
        <body>
          <div class="ticket">
